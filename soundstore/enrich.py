...
for codec, encoding, duration, rate, channels in tqdm.tqdm(pool.imap_unordered(enrich_sample, sample_dirs), ascii=True, ncols=20, mininterval=0.5, total=len(sample_dirs)):
